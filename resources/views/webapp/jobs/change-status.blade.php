...
@section('title', 'Change Job Status')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            <a href="{{ route('admin.jobs.details', $job->id) }}" class="mr-3 text-gray-600 hover:text-gray-900">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
            </a>
            <h1 class="text-2xl font-bold text-gray-900">Change Job Status</h1>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-lg p-6 border border-blue-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-900 font-medium">{{ $job->employer->company_name ?? 'N/A' }}</p>
            </div>
            @endif
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        ...
        <form method="POST" action="{{ route('admin.jobs.update-status', $job->id) }}" class="space-y-6">
            @csrf
