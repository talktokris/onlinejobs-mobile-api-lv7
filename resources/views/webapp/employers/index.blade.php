...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="GET" action="{{ route('admin.employers.index') }}" class="space-y-4">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @empty
                    <tr>
                        <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">No employers found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
