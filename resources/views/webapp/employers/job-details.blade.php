...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.employers.show', $employer->id) }}" class="px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-700">
            Back to Employer
        </a>
    </div>
                        ...
                        @foreach($applicants as $applicant)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.employers.jobs.applicants.show', [$employer->id, $job->id, $applicant->user_id]) }}" class="text-blue-600 hover:text-blue-900">View Details & Messages</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
