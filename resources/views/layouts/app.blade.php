                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <div x-data="{ open: {{ request()->routeIs('admin.settings.*') ? 'true' : 'false' }} }">
                                <button @click="open = !open" class="w-full flex items-center justify-between px-4 py-2 rounded hover:bg-gray-700 {{ request()->routeIs('admin.settings.*') ? 'bg-gray-700' : '' }}">
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <ul x-show="open" 
                                    ...
                                    class="ml-4 mt-2 space-y-1 border-l-2 border-gray-700 pl-4">
                                    <li>
                                        <a href="{{ route('admin.settings.category', 'countries') }}" class="flex items-center px-4 py-2 rounded hover:bg-gray-700 {{ (request()->route('category') == 'countries' || request()->segment(3) == 'countries') ? 'bg-gray-700' : '' }}">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.settings.category', 'genders') }}" class="flex items-center px-4 py-2 rounded hover:bg-gray-700 {{ (request()->route('category') == 'genders' || request()->segment(3) == 'genders') ? 'bg-gray-700' : '' }}">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                                            </svg>
                                            Manage Genders
                                    ...
                                    <li>
                                        <a href="{{ route('admin.settings.category', 'languages') }}" class="flex items-center px-4 py-2 rounded hover:bg-gray-700 {{ (request()->route('category') == 'languages' || request()->segment(3) == 'languages') ? 'bg-gray-700' : '' }}">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.settings.category', 'religions') }}" class="flex items-center px-4 py-2 rounded hover:bg-gray-700 {{ (request()->route('category') == 'religions' || request()->segment(3) == 'religions') ? 'bg-gray-700' : '' }}">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.settings.category', 'marital-statuses') }}" class="flex items-center px-4 py-2 rounded hover:bg-gray-700 {{ (request()->route('category') == 'marital-statuses' || request()->segment(3) == 'marital-statuses') ? 'bg-gray-700' : '' }}">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.settings.category', 'options') }}" class="flex items-center px-4 py-2 rounded hover:bg-gray-700 {{ (request()->route('category') == 'options' || request()->segment(3) == 'options') ? 'bg-gray-700' : '' }}">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                                            </svg>
                                            Manage App Options Fills
                                        </a>
                                    </li>
                                </ul>
                            </div>
