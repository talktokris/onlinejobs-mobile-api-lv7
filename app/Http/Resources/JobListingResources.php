...
class JobListingResources extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'bookmarks'=>  JobBookmarkResources::collection($this->jobBookmarks),
            'applicants'=>  JobApplicantResources::collection($this->jobApplicantsAll),
