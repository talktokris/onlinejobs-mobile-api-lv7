...
class EmployerUserProfileResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'applicants'=>  JobDetailsResources::collection($this->applicants),
            ...
            'resume_bookmarks'=>  SingleResumeBookmarkResouce::collection($this->resume_bookmarks),
           
            // 'resume_bookmarks'=>  $this->resume_bookmarks,
// use App\Http\Resources\SingleResumeBookmarkResouce;
